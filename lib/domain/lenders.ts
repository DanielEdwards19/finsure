...
export const LENDERS: readonly Lender[] = [
  lender("Commonwealth Bank", "CB", "rgb(255,255,255)", "rgb(20,20,20)", "commonwealth-bank.png"),
  ...
  lender("Macquarie Bank", "M", "rgb(255,255,255)", "rgb(35,31,32)", "macquarie-bank.png"),
  lender("Suncorp Bank", "S", "rgb(255,255,255)", "rgb(20,20,20)", "suncorp-bank.png"),
  lender("Bank of Queensland", "BOQ", "rgb(255,255,255)", "rgb(0,61,124)", "bank-of-queensland.png"),
  ...
  lender("Great Southern Bank", "GS", "rgb(0,56,77)", null, "great-southern-bank.png"),
  lender("Heritage Bank", "H", "rgb(255,255,255)", "rgb(20,20,20)", "heritage-bank.png"),
  lender("Firstmac", "FM", "rgb(0,0,0)", null, "firstmac.png"),
  lender("Pepper Money", "PM", "rgb(222,8,36)", null, "pepper-money.png"),
  lender("Liberty Financial", "LF", "rgb(0,89,169)", null, "liberty-financial.png"),
...
> = {
  "Commonwealth Bank": { address: "Commonwealth Bank Place, 1 Harbour St, Sydney NSW 2000", lat: -33.8688, lon: 151.202 },
  Westpac: { address: "275 Kent St, Sydney NSW 2000", lat: -33.8663, lon: 151.205 },
  NAB: { address: "395 Bourke St, Melbourne VIC 3000", lat: -37.8145, lon: 144.9612 },
  ANZ: { address: "833 Collins St, Docklands VIC 3008", lat: -37.821, lon: 144.943 },
  "Macquarie Bank": { address: "50 Martin Pl, Sydney NSW 2000", lat: -33.8675, lon: 151.21 },
  "Suncorp Bank": { address: "80 Ann St, Brisbane QLD 4000", lat: -27.466, lon: 153.025 },
  "Bank of Queensland": { address: "100 Skyring Tce, Newstead QLD 4006", lat: -27.445, lon: 153.043 },
  Bankwest: { address: "300 Murray St, Perth WA 6000", lat: -31.952, lon: 115.857 },
  "St.George Bank": { address: "182 George St, Sydney NSW 2000", lat: -33.864, lon: 151.208 },
  "Bendigo Bank": { address: "2 Bendigo Bank Pl, Bendigo VIC 3550", lat: -36.758, lon: 144.279 },
  "Heritage Bank": { address: "400 Ruthven St, Toowoomba QLD 4350", lat: -27.561, lon: 151.954 },
  "AMP Bank": { address: "33 Alfred St, Sydney NSW 2000", lat: -33.8615, lon: 151.211 },
  ING: { address: "60 Margaret St, Sydney NSW 2000", lat: -33.866, lon: 151.207 },
  ubank: { address: "367 Collins St, Melbourne VIC 3000", lat: -37.817, lon: 144.96 },
  "Pepper Money": { address: "177 Pacific Hwy, North Sydney NSW 2060", lat: -33.838, lon: 151.207 },
  "Liberty Financial": { address: "201 Kent St, Sydney NSW 2000", lat: -33.867, lon: 151.204 },
  Firstmac: { address: "486 Ann St, Brisbane QLD 4000", lat: -27.462, lon: 153.029 },
  "Great Southern Bank": { address: "100 Wickham St, Fortitude Valley QLD 4006", lat: -27.458, lon: 153.033 },
};
