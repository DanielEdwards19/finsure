...
export const DOCUMENTS: readonly ClientDocument[] = [
  {
    id: "d01",
    file: "01_Infynity_Client_Record.json",
    name: "Infynity client record",
    source: "Infynity",
    ...
    summary:
      "Structured client, broker, application, employment and condition record exported from Infynity.",
    detail: [
  ...
  {
    id: "d02",
    file: "02_Infynity_Application_Export.csv",
    name: "Infynity application export",
    source: "Infynity",
    kind: "Application record",
    date: "5 Jun 2026",
    size: "1 KB",
    ...
    category: "Application data",
    summary:
      "Flat field export of the application, including the one open lender condition.",
    detail: [
  ...
  {
    id: "d03",
    file: "03_Needs_and_Objectives_Assessment.docx",
    name: "Needs and objectives assessment",
    source: "Broker file / SharePoint",
    kind: "Needs and objectives record",
    date: "5 Jun 2026",
    size: "39 KB",
    status: "EVIDENCE_FOUND",
    category: "Needs and objectives",
    summary:
      "Records purpose, requested amount, repayment preferences, offset requirement, flexibility and timing.",
    detail: [
  ...
  {
    id: "d04",
    file: "04_Broker_File_Notes.docx",
    name: "Broker file notes",
    source: "Broker file / SharePoint",
    kind: "Broker file note",
    date: "5 Jun 2026",
    size: "39 KB",
    status: "EVIDENCE_FOUND",
    category: "Record quality",
    summary:
      "Chronological record of advice, verification and application activity.",
    detail: [
  ...
  {
    id: "d05",
    file: "05_Employment_Verification_Record.docx",
    name: "Employment verification record",
    source: "Broker file / SharePoint",
    ...
    summary:
      "Independent employer confirmation with the income evidence reviewed.",
    detail: [
  ...
  {
    id: "d06",
    file: "06_Preliminary_Assessment.pdf",
    name: "Preliminary assessment",
    source: "Broker file / SharePoint",
    kind: "Preliminary assessment",
    date: "27 May 2026",
    size: "46 KB",
    status: "EVIDENCE_FOUND",
    category: "Assessment",
    summary:
      "Servicing and suitability assessment supporting the recommendation.",
    detail: [
  ...
  {
    id: "d07",
    file: "07_Credit_Proposal_and_Product_Comparison.pdf",
    name: "Credit proposal and product comparison",
    source: "Broker file / SharePoint",
    kind: "Credit proposal",
    date: "27 May 2026",
    size: "46 KB",
    status: "EVIDENCE_FOUND",
    category: "Options and comparison",
    summary:
      "Compares Westpac, ANZ and Macquarie with reasons for the recommendation.",
    detail: [
  ...
  {
    id: "d08",
    file: "08_Westpac_Conditional_Approval_PROTOTYPE.pdf",
    name: "Westpac conditional approval",
    source: "Lender portal simulation",
    ...
    summary:
      "Conditional approval with outstanding conditions, including verification of funds to complete.",
    detail: [
  ...
  {
    id: "d09",
    file: "09_Building_Insurance_Certificate_PROTOTYPE.pdf",
    ...
    category: "Lender conditions",
    summary:
      "Insurance certificate provided by the client and accepted by the broker.",
    detail: [
  ...
  {
    id: "d10",
    file: "10_Julie_Smith_NAB_Offset_Statement_PROTOTYPE.pdf",
    name: "NAB offset account statement",
    source: "Manual upload",
    kind: "Bank statement",
    date: "4 Jun 2026",
    size: "44 KB",
    ...
    summary:
      "Shows the $82,000 held for settlement and the $25,000 credit dated 28 May 2026.",
    detail: [
  ...
  {
    id: "d11",
    file: "11_Source_of_Funds_Declaration_UNSIGNED.pdf",
    name: "Source of funds declaration (unsigned)",
    source: "Broker file / SharePoint",
    kind: "Declaration",
    date: "5 Jun 2026",
    size: "44 KB",
    ...
    category: "Source of funds",
    summary:
      "Declaration prepared but not signed — not evidence that the lender condition is met.",
    detail: [
  ...
  {
    id: "d12",
    file: "12_Contract_of_Sale_Extract_PROTOTYPE.pdf",
    name: "Contract of sale extract",
    source: "Manual upload",
    ...
    summary:
      "Contract extract relevant to the cooling-off question referred to the conveyancer.",
    detail: [
  ...
  {
    id: "d13",
    file: "13_Identification_Checklist.docx",
    name: "Identification and verification checklist",
    source: "Broker file / SharePoint",
    kind: "Identification",
    date: "5 Jun 2026",
    size: "38 KB",
  ...
  {
    id: "d14",
    file: "14_Disclosure_and_Consent_Record_PROTOTYPE.pdf",
    name: "Disclosure and consent record",
    source: "Broker file / SharePoint",
    kind: "Disclosure record",
    date: "20 May 2026",
    size: "44 KB",
    status: "EVIDENCE_FOUND",
    category: "Disclosure and consent",
    summary:
      "Records privacy consent and the disclosures provided to the client.",
    detail: [
  ...
  {
    id: "d15",
    file: "15_Julie_Smith_Email_Thread_Extract.txt",
    name: "Email thread extract (Outlook)",
    source: "Outlook",
    ...
    summary:
      "Full thread: cooling-off referral, Westpac conditions and the source-of-funds follow-up.",
    detail: [
  ...
  {
    id: "d16",
    file: "16_Expected_Prototype_Findings.txt",
    name: "Expected prototype findings",
    source: "Prototype logic",
    ...
    summary:
      "Reference set describing the findings the prototype should surface for this file.",
    detail: ["Prototype logic reference, not part of the client record."],
  },
  {
    id: "d17",
    file: "17_Document_Manifest.csv",
    name: "Document manifest",
    source: "Prototype package",
    kind: "Manifest",
    date: "5 Jun 2026",
    size: "2 KB",
    status: "EVIDENCE_FOUND",
    category: "Analysis reference",
    summary:
      "Index of every document in the package with its simulated source system.",
    detail: [
      "17 records across Infynity, broker file / SharePoint, lender portal simulation, Outlook and manual upload.",
    ],
  },
];
